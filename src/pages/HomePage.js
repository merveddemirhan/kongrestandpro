...
// Eksik ikonları import ediyoruz
import { FiShield, FiUsers } from 'react-icons/fi';

function HomePage() {
  return (
    <div>
      {/* === BÖLÜM 1: TAM EKRAN KARŞILAMA GÖRSELİ (Dokunulmadı) === */}
      <div
      ...
      {/* === BÖLÜM 2: MODERN TANITIM BÖLÜMÜ (Dikey boşluk ayarlandı) === */}
      ...
      {/* === BÖLÜM 3: ÖNE ÇIKAN FUAR STANDI TASARIMLARI (Yazı boyutu ayarlandı) === */}
      <section className="py-20 sm:py-24 bg-gray-100">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* ... Kartlar aynı, yapıları zaten responsive ... */}
            ...
            <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"><img src="/5.jpeg" alt="Modern Fuar Standı Tasarımı 6" className="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-105" /><div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-70 transition-opacity duration-300 flex items-end p-6"><h3 className="text-white text-xl font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300 translate-y-4 group-hover:translate-y-0"></h3></div></div>
          </div>
          <div className="mt-16 text-center">
            {/* ... Buton aynı ... */}
            <NavLink to="/projeler" className="inline-flex items-center px-8 md:px-10 py-3 md:py-4 border border-transparent text-lg md:text-xl font-semibold rounded-full shadow-lg text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>Tüm Projeleri Keşfet</NavLink>
          </div>
        </div>
      </section>

      {/* === BÖLÜM 4: FUAR STANDI ÇÖZÜMLERİ (Yazı boyutu ayarlandı) === */}
      <section className="bg-slate-50 py-20 sm:py-24">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            {/* ... içerik aynı ... */}
            <div className="flex justify-center"><img src="/1.jpeg" alt="Fuar Standı Tasarımı ve Üretimi" className="rounded-xl shadow-xl w-full max-w-xl object-contain"/></div>
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">Fuar Standı Çözümleri: Tasarım, Üretim ve Kiralama</h2>
              <div className="mt-4 w-20 h-1.5 bg-blue-600 rounded-full"></div>
              <p className="mt-6 text-lg text-gray-600 leading-relaxed">Her marka eşsizdir, bu yüzden her stand da benzersiz bir kimliğe sahip olmalıdır. Biz, markanızın değerlerini ve hedeflerini yansıtan, yüksek kalitede fuar standları tasarlıyoruz. Tasarım aşamasından fuar alanındaki son vidaya kadar tüm süreci kusursuz bir şekilde yöneterek size anahtar teslim çözümler sunuyoruz.</p>
              <ul className="mt-8 space-y-4 text-lg text-gray-700"><li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Stratejik Tasarım ve 3D Modelleme: Markanızı rakiplerinizden ayıracak, estetik ve fonksiyonel tasarımlar.</span></li><li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Anahtar Teslim Üretim ve Kurulum: Fikirden gerçeğe, atölyemizden fuar alanına kadar tüm süreci yönetiyoruz.</span></li><li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Bütçe Dostu ve Esnek Kiralama Çözümleri: Projenizin ihtiyaçlarına ve bütçenize en uygun kiralama seçenekleri.</span></li><li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Türkiye Genelinde Lojistik ve Saha Desteği: Nerede olursanız olun, zamanında ve sorunsuz kurulum garantisi.</span></li></ul>
            </div>
          </div>
        </div>
      </section>

      {/* === BÖLÜM 5: 360° HİZMETLER (Dokunulmadı, yapısı zaten responsive) === */}
      ...
      {/* === BÖLÜM 6: NEDEN BİZ? (Yazı boyutu ayarlandı) === */}
      <section className="bg-white py-20 sm:py-24">
        {/* ... içerik aynı ... */}
      ...
      {/* === BÖLÜM 7: İLETİŞİM KARTLARI (EN ÖNEMLİ DÜZELTME) === */}
      <section className="py-20 sm:py-24 bg-gray-900 text-white text-center">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center text-white mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">KONGRESTANDPRO olarak kongre ve fuarlarda size özel stand çözümleri sunuyoruz. Projeniz hakkında konuşmak ve hızlı teklif almak için bize ulaşın.</p>
          </div>
