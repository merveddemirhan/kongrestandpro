...
function HomePage() {
  return (
    <div>
      ...
      <style>
        {`
          .hero-background { background-image: url(/arkaplan.png); }
          @media (max-width: 768px) {
            .hero-background { background-image: url(/arkaplan-mobil.png); }
          }
        `}
      </style>
      ...
      {/* === BÖLÜM 1: HERO === */}
      <div
        className="hero-background relative h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center text-center overflow-hidden"
      >
        <div className="absolute inset-0 bg-black bg-opacity-60"></div>
        <div className="relative z-10 px-6">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mt-0">
      ...
      <section className="py-20 sm:py-24 bg-gray-100">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { src: '/7x32.jpeg', alt: 'Modern Fuar Standı Tasarımı 2' },
              { src: '/2.jpeg', alt: 'Modern Fuar Standı Tasarımı 3' },
              { src: '/3.jpeg', alt: 'Modern Fuar Standı Tasarımı 4' },
              { src: '/4.jpeg', alt: 'Modern Fuar Standı Tasarımı 5' },
              { src: '/5.jpeg', alt: 'Modern Fuar Standı Tasarımı 6' },
            ].map((img, i) => (
              <div
                key={i}
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="flex justify-center">
              <img
                src="/1.jpeg"
                alt="Fuar Standı Tasarımı ve Üretimi"
            ...
            <div>
              ...
              <ul className="mt-8 space-y-4 text-lg text-gray-700">
                <li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Stratejik Tasarım ve 3D Modelleme: Estetik ve fonksiyonel tasarımlar.</span></li>
                <li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Anahtar Teslim Üretim ve Kurulum: Fikirden sahaya kadar tüm süreç.</span></li>
                <li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Bütçe Dostu ve Esnek Kiralama: İhtiyaca ve bütçeye uygun.</span></li>
                <li className="flex items-center"><IoIosCheckmarkCircle className="text-blue-600 h-7 w-7 mr-3 flex-shrink-0" /><span>Türkiye Genelinde Lojistik ve Saha Desteği: Zamanında ve sorunsuz kurulum.</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      {/* === BÖLÜM 5: 360° HİZMETLER === */}
      <section className="bg-gray-50 py-20 sm:py-24">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight">360° Fuar Standı Hizmetleri</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <div className="text-center">
              <div className="overflow-hidden rounded-lg shadow-lg">
                <img src="/tasarım.jpeg" alt="Tasarım Hizmetleri" className="w-full h-64 object-cover transform hover:scale-105 transition-transform duration-500 ease-out" loading="lazy" decoding="async" width="960" height="640" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Tasarım Hizmetleri</h3>
              <p className="text-gray-600 mb-4">Markanıza özel, dikkat çekici ve sahada uygulanabilir 3D stand tasarımları sunarız.</p>
              <NavLink to="/projeler" className="text-blue-600 font-semibold hover:underline">Stand Tasarımlarımızı İnceleyin</NavLink>
            </div>

            <div className="text-center">
              <div className="overflow-hidden rounded-lg shadow-lg">
                <img src="/uretim.jpg" alt="Üretim Hizmetleri" className="w-full h-64 object-cover transform hover:scale-105 transition-transform duration-500 ease-out" loading="lazy" decoding="async" width="960" height="640" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Üretim Hizmetleri</h3>
              <p className="text-gray-600 mb-4">Kendi atölyemizde usta işçilik ve kaliteli malzemelerle hayata geçiriyoruz.</p>
            ...
            <div className="text-center">
              <div className="overflow-hidden rounded-lg shadow-lg">
                <img src="/lojistik.jpg" alt="Lojistik ve Kurulum" className="w-full h-64 object-cover transform hover:scale-105 transition-transform duration-500 ease-out" loading="lazy" decoding="async" width="960" height="640" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-3">Lojistik ve Kurulum</h3>
              <p className="text-gray-600 mb-4">Profesyonel lojistik ağı ve saha ekibiyle zamanında, hatasız kurulum.</p>
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="flex justify-center">
              <img src="/isbirligi.jpeg" alt="Neden Bizi Tercih Etmelisiniz" className="rounded-2xl shadow-xl w-full max-w-md object-cover" loading="lazy" decoding="async" width="800" height="600" />
            </div>
            <div>
              <p className="text-blue-600 font-semibold tracking-wide uppercase">PROJENİZE DEĞER KATIYORUZ</p>
              <h2 className="mt-2 text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight">Neden Bizi Tercih Etmelisiniz?</h2>
              <div className="mt-10 space-y-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">Tasarım masasından fuar alanındaki son vidaya kadar tüm süreci sizin için tek merkezden yönetiyoruz.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 text-gray-600">Tasarım, üretim ve saha operasyonlarında deneyimli ekiple çalışın.</p>
                  </div>
                </div>
              </div>

              <div className="mt-12">
                <NavLink to="/iletisim" className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-4 px-10 rounded-lg shadow-lg hover:scale-105 transform transition-transform duration-300 ease-in-out">
                  İletişime Geçin
                </NavLink>
              </div>
            </div>
      ...
      <section className="py-20 sm:py-24 bg-gray-900 text-white text-center">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center text-white mb-16">
            <p className="text-blue-400 font-semibold tracking-widest uppercase mb-2">HEMEN İLETİŞİME GEÇİN</p>
            <h2 className="text-4xl sm:text-5xl font-extrabold leading-snug tracking-tight mb-4">Fuar Başarınız İçin Hazırız!</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-gray-800 p-6 rounded-xl shadow-2xl transition-all duration-300 hover:bg-blue-600 hover:text-white group">
              ...
              <a href="tel:+905511813241" className="text-blue-400 group-hover:text-white font-semibold text-sm hover:underline transition-colors duration-300">+90 551 181 32 41</a>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-2xl transition-all duration-300 hover:bg-blue-600 hover:text-white group">
              ...
              <a href="mailto:kongrestandpro@gmail.com" className="text-blue-400 group-hover:text-white font-semibold text-sm hover:underline transition-colors duration-300">kongrestandpro@gmail.com</a>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-2xl transition-all duration-300 hover:bg-blue-600 hover:text-white group">
              ...
              <a
                href="https://wa.me/905382172168?text=Merhaba,%20KONGRESTANDPRO%20hizmetleriniz%20hakkında%20bilgi%20almak%20istiyorum."
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-400 group-hover:text-white font-semibold text-sm hover:underline transition-colors duration-300"
              >
                Hemen Mesaj Gönder
              </a>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-xl shadow-2xl transition-all duration-300 hover:bg-blue-600 hover:text-white group">
              ...
              <a href="https://www.instagram.com/kongrestandpro" target="_blank" rel="noopener noreferrer" className="text-blue-400 group-hover:text-white font-semibold text-sm hover:underline transition-colors duration-300">@kongrestandpro</a>
            </div>
          </div>
        </div>
      </section>
