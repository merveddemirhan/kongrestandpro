...
// Bu, her bir proje bölümünü render eden, tekrar kullanılabilir bir bileşen.
// Kod tekrarını önler ve yönetimi kolaylaştırır.
const ProjectSection = ({ project, imageFirst = false }) => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        {/* Metin Sütunu */}
        <div className={`lg:sticky lg:top-24 ${imageFirst ? 'lg:order-last' : ''}`}>
            <h1 className="text-3xl lg:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">{project.title}</h1>
            <p className="text-lg text-gray-700 mb-8 leading-relaxed whitespace-pre-line">{project.description}</p>
  ...
  return (
    <div className="bg-gray-50 min-h-screen pt-16">
      <div className="container mx-auto px-6 py-12 lg:py-16 space-y-16 lg:space-y-24">
        ...
        <ProjectSection project={projectData2} imageFirst={true} /> {/* Dinamik akış için görseli sola alıyoruz */}
        <ProjectSection project={projectData3} />
        <ProjectSection project={projectData4} imageFirst={true} /> {/* Dinamik akış için görseli sola alıyoruz */}
