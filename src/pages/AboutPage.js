        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-gray-700">
            ...
            <p className="text-lg mb-6">
              Biz, fuar ve etkinlik sektöründe sıradan standlar üretmenin ötesine geçerek, markaların kimliğini ve vizyonunu yansıtan özgün mekanlar tasarlayan bir ekibiz. 2025 yılında Bursa'da başlayan yolculuğumuz, Türkiye'nin dört bir yanındaki fuarlarda sayısız markanın başarı hikayesine ortak olmamızla devam etti.
            </p>
